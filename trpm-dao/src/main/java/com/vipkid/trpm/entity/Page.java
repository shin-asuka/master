...
//        sb.append("<input type=\"hidden\" id=\"pageLastNoId\" value=\"" + last + "\"/> ");
//        sb.append("当前<input type=\"text\" id=\"pageNoId\" value=\"" + pageNo
//                + "\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
//        sb.append(funcName + "(this.value," + pageSize + ",'" + funcParam + "');\" onclick=\"this.select();\"/> / ");
//        sb.append("<input type=\"text\" id=\"pageSizeId\" value=\"" + pageSize
//                + "\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
