...
public class LoginController extends RestfulController {
    ...
    public Map<String, Object> login(HttpServletRequest request, HttpServletResponse response,
        ...
        try{
            ...
            if(CollectionUtils.isNotEmpty(list) && list.get(0).isResult()){
                ...
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_ERROR, this);
            }
            ...
            if (StringUtils.isEmpty(ip) || passportService.isExceedMaxLoginPerIP(ip)
                ...
                if (StringUtils.isBlank(bean.getKey()) || StringUtils.isBlank(bean.getImageCode())) {
                    ...
                    response.setStatus(HttpStatus.BAD_REQUEST.value());
                    return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.VERIFY_CODE, this);
                    ...
                    response.setStatus(HttpStatus.BAD_REQUEST.value());
                    return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.VERIFY_CODE_ERROR, this);
                }
            }
            ...
            if (null == user) {
                ...
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_NULL, this);
            }
            // token check
            ...
            if (!mypwd.equals(user.getPassword())) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.PWD_ERROR, this);
            }
            // 检查用户类型
            if (!UserEnum.Dtype.TEACHER.val().equals(user.getDtype())) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.DTYPE_ERROR, this);
            }
            // techer null check
            ...
            if (teacher == null) {
                ...
                response.setStatus(HttpStatus.NOT_FOUND.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.TEACHER_NULL, this);
            }
            ...
            if (TeacherEnum.LifeCycle.FAIL.toString().equals(teacher.getLifeCycle())) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_FAIL, this);
            }    
            ...
            if (TeacherEnum.LifeCycle.QUIT.toString().equals(teacher.getLifeCycle())) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_QUIT, this);
            }
            ...
            if (UserEnum.Status.isLocked(user.getStatus())) {
                ...
                if (TeacherEnum.LifeCycle.SIGNUP.toString().equals(teacher.getLifeCycle())) {
                    if(PropertyConfigurer.booleanValue("signup.send.mail.switch")){
                        ...
                        response.setStatus(HttpStatus.BAD_REQUEST.value());
                        return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_ACTIVITY, this);
                    }else{
                    ...
                    response.setStatus(HttpStatus.BAD_REQUEST.value());
                    return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_LOCKED, this);
                }            
            }
    ...
    public Map<String, Object> register(HttpServletRequest request, HttpServletResponse response,
        ...
        try{
            ...
            if (user != null) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.USER_EXITS, this);
                // 2.用户名可用，执行业务，
            }
            // 执行业务逻辑
    ...
    public Map<String, Object> resetPassword(HttpServletRequest request, HttpServletResponse response,
        ...
        try{
            ...
            if (!this.passportService.checkTokenTimeout(bean.getToken())) {
                ...
                response.setStatus(HttpStatus.BAD_REQUEST.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.TOKEN_OVERDUE, this);
            }
            ...
            if (MapReturnUtils.isFail(retMap)) {
                response.setStatus(HttpStatus.FORBIDDEN.value());
                return MapReturnUtils.responseFail(ApplicationConstant.AjaxCode.TOKEN_ERROR, this);
            }
    ...
    public Map<String, Object> auth(HttpServletRequest request, HttpServletResponse response) {
        try{
            ...
            Map<String,Object> success = MapReturnUtils.responseSuccess();
