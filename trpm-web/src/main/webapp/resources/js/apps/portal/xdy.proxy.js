define([ 'messenger',"jquery-bootstrap" ], function() {
	...
	var messenger = new Messenger('parent', 'MessengerChannel');
	...
	var initChannel = function(uid, roomId, debug, stars) {
		...
		var iframeId = 'xuedianyun';
		jQuery(document).ready(function() {
			messenger.addTarget(document.getElementById('xuedianyun').contentWindow, 'xuedianyun');
		});
